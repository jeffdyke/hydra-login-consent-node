...
router.get("/", csrfProtection, (req, res) => {
    ...
    if (code && req.session) {
        ...
        jsonLogger.info("State %s vs ReturnedState: %s with Code %s", storedState, returnedState, codeVerifier);
        ...
        fetch(`${HYDRA_URL}/oauth2/token`, {
            ...
            const resp = googleTokenResponse(code);
